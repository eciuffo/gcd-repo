...
# Attention Here; new domains were created here. These domains were not part of the original file,
# but they have bee addded for better visualization of the data. Below are the meaning of such Domains:
#           at -> Angle Time Domain
#           ax -> Angle X axis Domain
#           aY -> Angle Y axis Domain
#           aZ -> Angle Z axis Domain
# 
...
# Removing "," uneeded characters from names
featureVector <- sub("\\,","",featureVector,)

# removing "(" and  ")" characters from feature names
...
# ----------------- Trimming features according to requirements ---------------------
